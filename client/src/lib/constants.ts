...
export const SKILLS: Skill[] = [
  { id: 1, name: "PyTorch", category: "AI/ML", proficiency: 95 },
  { id: 2, name: "TensorFlow", category: "AI/ML", proficiency: 90 },
  { id: 3, name: "Reinforcement Learning", category: "AI/ML", proficiency: 85 },
  { id: 4, name: "Python", category: "Languages", proficiency: 95 },
  { id: 5, name: "JavaScript/React", category: "Web", proficiency: 85 },
  { id: 6, name: "C++", category: "Languages", proficiency: 80 },
  { id: 7, name: "Docker", category: "Tools", proficiency: 85 },
  { id: 8, name: "PostgreSQL", category: "Backend", proficiency: 80 },
  { id: 9, name: "Mechatronics/Robotics", category: "Engineering", proficiency: 90 },
];
